...
/** UI-level message: either a server-confirmed message or a pending outgoing one. */
data class ChatItem(
    val key: String,                    // stable key for LazyColumn
    val serverId: Long?,                // null for pending
    val from: String,
    val text: String?,
